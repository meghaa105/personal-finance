    ...
    <>
      {show && (
        <div className="fixed inset-0 bg-black/50 dark:bg-black/80 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800/95 rounded-lg shadow-lg p-6 w-full max-w-lg mx-4">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Filter Transactions</h3>
              <button
                onClick={onClose}
                className="p-2 text-red-600 hover:bg-red-300/50 rounded-full transition-all duration-200 ease-in-out"
              >
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Transaction Type</label>
                <select
                  name="type"
                  value={filters.type}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Payment Method</label>
                <select
                  name="paymentMethod"
