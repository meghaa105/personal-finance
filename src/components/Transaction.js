...
export default function Transaction({ transaction, onEdit, onDelete }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-3 sm:p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-300 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-600 group">
      ...
      <div className="flex items-center gap-2 mt-2 sm:mt-0 ml-auto sm:ml-0 flex-shrink-0">
        <p className={`text-sm sm:text-lg font-semibold px-2 sm:px-4 py-1 sm:py-2 rounded-lg ${transaction.type === 'income' ? 'text-green-700 dark:text-green-300 bg-green-100 dark:bg-green-900/30' : 'text-red-700 dark:text-red-300 bg-red-100 dark:bg-red-900/30'}`}>
